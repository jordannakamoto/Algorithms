...
in fibSeq2, why do you think fibSeq2 has only an int as parameter, rather than an int and an array as defined in fibSeq2Helper?

Explain in a few sentences the role of the array arr.

In fibSeq2Helper, why not declare and initialize the array in one step?
    int arr [n+1] = {0};
